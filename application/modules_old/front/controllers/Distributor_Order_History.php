			...
			//    $distributorselect = $_POST['distributor_select'];
			  ...
			  if($distributor->is_admin==0){
			   if (!empty( $_POST['statusvalue']) &&  $_POST['statusvalue'] == 'unassign') {
				$where_condition4 = array('orders.distributor_id' => $this->session->userdata('id'),'orders.status'=>0,'orders.is_new'=>1);
			   }elseif(!empty( $_POST['statusvalue']) &&  $_POST['statusvalue'] == 'dispatched'){
				$where_condition4 = array('orders.distributor_id' => $this->session->userdata('id'),'orders.status'=>0,'orders.is_dispatch'=>1);
			   }elseif(!empty( $_POST['statusvalue']) &&  $_POST['statusvalue'] == 'pending'){
				$where_condition4 = array('orders.distributor_id' => $this->session->userdata('id'),'orders.status'=>0,'orders.is_hold'=>1);
			   }elseif(!empty( $_POST['statusvalue']) &&  $_POST['statusvalue'] == 'cancel'){
				$where_condition4 = array('orders.distributor_id' => $this->session->userdata('id'),'orders.status'=>0,'orders.is_cancel'=>1);
			   }elseif(!empty( $_POST['statusvalue']) &&  $_POST['statusvalue'] == 'deliver'){
				$where_condition4 = array('orders.distributor_id' => $this->session->userdata('id'),'orders.status'=>1);
			   } else {
				$where_condition4 = array('orders.distributor_id'=>$this->session->userdata('id'));
			   }
			  }else{
				if (!empty( $_POST['statusvalue']) &&  $_POST['statusvalue'] == 'unassign') {
					$where_condition4 = array('orders.status'=>0,'orders.is_new'=>1);
				   }elseif(!empty( $_POST['statusvalue']) &&  $_POST['statusvalue'] == 'dispatched'){
					$where_condition4 = array('orders.status'=>0,'orders.is_dispatch'=>1);
				   }elseif(!empty( $_POST['statusvalue']) &&  $_POST['statusvalue'] == 'pending'){
					$where_condition4 = array('orders.status'=>0,'orders.is_hold'=>1);
				   }elseif(!empty( $_POST['statusvalue']) &&  $_POST['statusvalue'] == 'cancel'){
					$where_condition4 = array('orders.status'=>0,'orders.is_cancel'=>1);
				   }elseif(!empty( $_POST['statusvalue']) &&  $_POST['statusvalue'] == 'deliver'){
					$where_condition4 = array('orders.status'=>1);
				   } else {
					$where_condition4 = array();
				   }
			  }
