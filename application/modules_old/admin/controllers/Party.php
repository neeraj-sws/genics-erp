...
{ 
		...
		$coloum_search = array('users.full_name','users.full_name');
	...
	$joins[] = array('table'=>' orders','condition'=>'orders.user_id=users.id','jointype'=>'inner');
	$joins[] = array('table'=>' distributor','condition'=>'distributor.id=orders.distributor_id','jointype'=>'inner');
