        ...
        <div class="col-12">
            ...
            <!-- /.card-header -->
				<div class="card-body pt-3 pb-3 ">
					<div class="row well ">
					<div class="col-3">
                      <select class="form-select select2 w-100" aria-label="Default select example" id="category_select">
                    ...
                    <button type="button" onclick="getSearchView();" class="me-2 pull-right btn btn-primary text-white">Apply</button>
                    </div>
					    	<div class="col-2 ml-auto">
    ...
    window.table = $('#datatable').DataTable({
		...
		"ajax": {
            ...
            "data": function(data){
                    ...
                    data.category = $('#category_select').val();
            },
