   ...
   <form  id="add_user" method="post" onsubmit="delivery_boy_save();return false;">
  ...
  $(document).ready(function() {
   ...
   $('.allowno').on('paste',function (e){
	...
	function delivery_boy_save()
	{
		...
		$.ajax({  
		  url :BASE_URL+"admin/delivery_boy/delivery_boy_save",  
		  method:"POST",  
		  dataType:"json",  
		  ...
		  success:function(res){  
			if(res.status == 0){
			  ...
			  toastr.success('Delivery Boy Added Successfully','Success');
